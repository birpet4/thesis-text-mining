...
TRAIN_DATA = [
    ...
    (
        ...
        {"entities": [(1069, 1090, "Internal-Reference"),(1096, 1118, "Internal-Reference")]}
    ),
    (
    ...
    (
        ...
        {"entities": [(1728, 1749, "Internal-Reference"), (1755, 1777, "Internal-Reference"), (1880, 1901, "Internal-Reference")]}
    ),
    (
    ...
    ,(
        ...
        {"entities": [(60,81, "Internal-Reference"), (147, 191, "Internal-Reference"), (967, 1007, "Internal-Reference"), (1062, 1108, "Internal-Reference"), (1350, 1390, "Internal-Reference")]}
    )
]
